<?php
class Redsonya_Form_Comment extends Zend_Form
{
  
	protected $_postid;
	
	public function __construct($postid, $options=null)
	{
	...
	{
		// initialize form
		$this->setAction('/blog/display/'.$this->_postid)
	         ->setMethod('post');
		
		$postid = new Zend_Form_Element_Hidden('post_id');
		$postid->setValue($this->_postid); //идентификатор поста
